...
class Forme { // Définition de la classe Forme
   private: // Section privée de la classe
    Point point_rigolo;
   ...
   public: // Section publique de la classe
    ...
    // Constructeur qui prend initialise un point_rigolo
    Forme(Point point_rigolo);

    // Constructeur de recopie qui prend une référence constante à un objet Forme et crée une copie de cet objet
    Forme(const Forme& f);
};
